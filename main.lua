...
------------------------------------------------------------------------------------------------------------------------
local function count_percent_W(S)
...
local function enter_and_Count()
    ...
    print('|-----|------|-------|----------|-------|-------|-----|--------|--------|------|--------------|--------------|')
    print('|  №  |  fн, |   fв, |   fср,   |dA(fср)|  Lс,  | Lш, |   qi   |   Qi   |  ki  |      pi      |      Ri      |')
    print('| п/п |  Гц  |   Гц  |    Гц    |       |   дБ  |  дБ |        |        |      |              |              |')
    print('|-----|------|-------|----------|-------|-------|-----|--------|--------|------|--------------|--------------|')
    for i = 1, N do
    ...
    io.write(' |' .. string.format('%13.10f', prW) .. ' |')
    io.write('\n')
    print('|--------------|--------------|--------------|--------------|')
end
